...
const About = () => {
  ...
  <div className="card-body">
    <h2 className="card-title text-blue-600 text-3xl md:text-5xl">25+</h2>
    ...
    <div className="card-actions justify-end">
            ...
            <div className='flex flex-col lg:pr-20'>
                ...
                <p className='leading-8 flex-grow'>Experience the difference with PRIMEDIAG — where leading healthcare meets personalized care, setting new benchmarks for a healthier, happier future.</p>
                <div className='flex items-center gap-2'><button className='btn rounded-full text-xl bg-blue-600 text-white'>Know More</button><BiSolidPhoneCall className='text-2xl'/><p className='text-black text-lg'>+380961381876</p></div>
            </div>
        </div>
    );
};
