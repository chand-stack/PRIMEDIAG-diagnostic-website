...
console.log(testDetail);
  ...
  <input required type="url" {...register("image")} placeholder="image url" className="input input-bordered w-full " />
  ...
  <input required type="number" {...register("slot")} placeholder="slot" className="input input-bordered w-full " />
  ...
  <input required type="text" {...register("price")} placeholder="price" className="input input-bordered w-full " />
  
</div>



      <button type="submit" className='btn w-full mt-3 text-white bg-blue-600 hover:bg-blue-800'>Add Test</button>
    </form>
